...
contract StandardToken is ERC20 {
    ...
    function bulkTransfer(address[] _to, uint[] _value) public returns (bool){
        uint arrayLength = _value.length;
        require(arrayLength == _to.length, "Invalid parameters");
        uint balance = balances[msg.sender];

        for (uint i = 0; i < arrayLength; i++){
            balance = balance.sub(_value[i]);
    ...
    function bulkTransferFrom(address[] _from, address[] _to, uint[] _value) public returns (bool){
        uint arrayLength = _from.length;
        require(arrayLength == _to.length, "Invalid parameters");
        require(arrayLength == _value.length, "Invalid parameters");
...
//token contract
contract BulkToken is Owned, StandardToken {
    ...
    function bulkTransfer(address[] _to, uint[] _value) public returns (bool){
        require(isTransferable);
        return super.bulkTransfer(_to, _value);
    }

    function bulkTransferFrom(address[] _from, address[] _to, uint[] _value) public returns (bool){
        require(isTransferable);
        return super.bulkTransferFrom(_from, _to, _value);
    } 
